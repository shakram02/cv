<style>
    ...
    ul, ol {
        margin: 6px;
        padding-left: 12px; /* Or a smaller value like 10px */
    }
    p {
        margin: 0;
    }
...
- Developed Spring Microservices with payment gateway third party integrations
...
- Collaborated with cross-functional, multi-national teams in Trella which is listed in LinkedIn's best-startups
...
- Developed a user portal using React to allow users to track their workloads, cancel and restart them
- Utilized SQS, Batch, EC2, S3, Lambda & ECR on AWS. IaC using Terraform

### Open-source Contributions

**1. Amazon Web Services, Firecracker** | [PR](https://github.com/firecracker-microvm/firecracker/pull/1238) | *Rust*
- Implemented full UDP support for the kernel-network-stack in AWS Lambda's Virtualization Engine
- Worked with TUN/TAP devices to parse/craft ARP, ETHERNET and MAC packets
...
**McKinsey & Company | Forward Program** – Equips individuals at different stages of their working life with practical skills to succeed in the future of work. It focuses on critical workplace skills that are relevant and transferable across industries and roles.
