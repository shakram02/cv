...
\begin{itemize*}
	...
	\item Designed and developed features while keeping in mind OOD and SOLID principles
...
\begin{itemize*}
	\item This paper was oriented towards controller security in SDN using controller redundancy
...
\colorsubsec{PI Floor: Portable Interactive Floor with High Resilience and Minimal Setup for Edutainment \\ MUM18 - \href{https://github.com/shakram02/PiFloor}{Github} -
...
\begin{itemize*}
	...
	\item The application utilized an embedded WebSockets and HTTP server, using Android vision and a VueJS app
\end{itemize*}
